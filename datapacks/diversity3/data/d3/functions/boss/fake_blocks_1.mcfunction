...
effect give @e[tag=Level1Mob] slowness 1 1 true
...
execute at @e[tag=StoneMob,nbt=!{Motion:[0.0d,0.0d,0.0d]}] if block ~ ~-0.1 ~ black_concrete run particle block black_concrete ~ ~ ~ 0.1 0.1 0.1 0 2 force
execute at @e[tag=StoneMob,nbt=!{Motion:[0.0d,0.0d,0.0d]}] if block ~ ~-0.1 ~ red_concrete run particle block red_concrete ~ ~ ~ 0.1 0.1 0.1 0 2 force
execute at @e[tag=StoneMob,nbt=!{Motion:[0.0d,0.0d,0.0d]}] if block ~ ~-0.1 ~ light_blue_concrete run particle block light_blue_concrete ~ ~ ~ 0.1 0.1 0.1 0 2 force
execute at @e[tag=StoneMob,nbt=!{Motion:[0.0d,0.0d,0.0d]}] if block ~ ~-0.1 ~ grass_block run particle block grass_block ~ ~ ~ 0.1 0.1 0.1 0 2 force
execute at @e[tag=StoneMob,nbt=!{Motion:[0.0d,0.0d,0.0d]}] if block ~ ~-0.1 ~ stone run particle block stone ~ ~ ~ 0.1 0.1 0.1 0 2 force
execute at @e[tag=StoneMob,nbt=!{Motion:[0.0d,0.0d,0.0d]}] if block ~ ~-0.1 ~ granite run particle block granite ~ ~ ~ 0.1 0.1 0.1 0 2 force
execute at @e[tag=StoneMob,nbt=!{Motion:[0.0d,0.0d,0.0d]}] if block ~ ~-0.1 ~ andesite run particle block andesite ~ ~ ~ 0.1 0.1 0.1 0 2 force
execute at @e[tag=StoneMob,nbt=!{Motion:[0.0d,0.0d,0.0d]}] if block ~ ~-0.1 ~ diorite run particle block diorite ~ ~ ~ 0.1 0.1 0.1 0 2 force
execute at @e[tag=StoneMob,nbt=!{Motion:[0.0d,0.0d,0.0d]}] if block ~ ~-0.1 ~ coal_ore run particle block stone ~ ~ ~ 0.1 0.1 0.1 0 2 force
...
execute as @e[tag=Level1Mob,nbt={HurtTime:10s}] at @s run playsound block.stone.break master @a ~ 64 ~ 1 1.3 0
...
# ROUND 1
execute if entity @e[tag=StoneMob1] unless entity @e[tag=StoneAS1] at @e[tag=StoneMob1] run summon armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b}],Invisible:true,NoGravity:true,Marker:true,Tags:["BossMob","StoneAS","StoneAS1","Level1Mob"],DisabledSlots:2039583}
execute if entity @e[tag=StoneMob2] unless entity @e[tag=StoneAS2] at @e[tag=StoneMob2] run summon armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b}],Invisible:true,NoGravity:true,Marker:true,Tags:["BossMob","StoneAS","StoneAS2","Level1Mob"],DisabledSlots:2039583}
execute if entity @e[tag=StoneMob3] unless entity @e[tag=StoneAS3] at @e[tag=StoneMob3] run summon armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b}],Invisible:true,NoGravity:true,Marker:true,Tags:["BossMob","StoneAS","StoneAS3","Level1Mob"],DisabledSlots:2039583}
execute if entity @e[tag=StoneMob4] unless entity @e[tag=StoneAS4] at @e[tag=StoneMob4] run summon armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b}],Invisible:true,NoGravity:true,Marker:true,Tags:["BossMob","StoneAS","StoneAS4","Level1Mob"],DisabledSlots:2039583}
