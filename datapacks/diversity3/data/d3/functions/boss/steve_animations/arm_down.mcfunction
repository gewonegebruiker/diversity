...
execute if block -1016 75 -953 white_terracotta run fill -1023 75 -953 -1016 78 -950 air replace white_terracotta
execute if block -1017 78 -952 black_terracotta run setblock -1017 78 -952 air

# SETS ARM DOWN
fill -1027 67 -953 -1024 74 -950 white_terracotta hollow