...
execute if entity @e[scores={BossLevel=35,BossTimer=200..}] align x align y align z if entity @e[scores={LaunchItem=1..},x=-1026,y=76,z=-963,dx=2,dy=2,dz=2] run scoreboard objectives add 
