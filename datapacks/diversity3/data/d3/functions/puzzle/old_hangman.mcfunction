...
# SEPTEMBER 7 2017 / MARCH 13 2019
...
execute if entity @e[scores={HangmanSetup=1}] run kill @e[tag=BannerBlocker]
#execute if entity @e[scores={HangmanSetup=1}] run kill @e[tag=BannerBlocker2]
...
execute as @e[scores={HangmanHint=1,HangmanSetup=500}] run playsound block.end_portal_frame.fill master @a 1002 63 -6 1 0.95 0
execute as @e[scores={HangmanHint=1,HangmanSetup=500}] run particle end_rod 1002 63 -6 0.3 1 0.3 0 50 force @a

execute as @e[scores={HangmanHint=1,HangmanSetup=700}] run playsound block.end_portal_frame.fill master @a 1002 63 -6 1 0.95 0
execute as @e[scores={HangmanHint=1,HangmanSetup=700}] run particle end_rod 1002 63 -6 0.3 1 0.3 0 50 force @a
execute as @e[scores={HangmanHint=1,HangmanSetup=700}] run summon area_effect_cloud 1002 63.4 -6 {CustomName:"{\"text\":\"↓\",\"bold\":\"false\"}",CustomNameVisible:true,Tags:["HangmanHintAEC"],Duration:2147483647}

execute as @e[scores={HangmanRound=1,HangmanHint=0,HangmanSetup=400..}] run kill @e[tag=HangmanHintAEC]
execute as @e[scores={HangmanHint=0,HangmanSetup=102..}] run scoreboard objectives remove HangmanHint
...
execute as @e[scores={HangmanSetup=90}] run scoreboard objectives add LetterTimer dummy
...
# ROUND 1 -> GLOWSTONE
scoreboard players set @e[scores={HangmanRound=1,LetterTimer=15,SelectedLetter=7}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=1,LetterTimer=65,SelectedLetter=7}] run playsound entity.arrow.hit_player master @a 996 66 -11 1 0.5 0

scoreboard players set @e[scores={HangmanRound=1,LetterTimer=15,SelectedLetter=12}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=1,LetterTimer=65,SelectedLetter=12}] run playsound entity.arrow.hit_player master @a 997 66 -11 1 0.55 0

scoreboard players set @e[scores={HangmanRound=1,LetterTimer=15,SelectedLetter=15}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=1,LetterTimer=65,SelectedLetter=15}] run playsound entity.arrow.hit_player master @a 998 66 -11 1 0.6 0

scoreboard players set @e[scores={HangmanRound=1,LetterTimer=15,SelectedLetter=23}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=1,LetterTimer=65,SelectedLetter=23}] run playsound entity.arrow.hit_player master @a 999 66 -11 1 0.65 0

scoreboard players set @e[scores={HangmanRound=1,LetterTimer=15,SelectedLetter=19}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=1,LetterTimer=65,SelectedLetter=19}] run playsound entity.arrow.hit_player master @a 1000 66 -11 1 0.7 0

scoreboard players set @e[scores={HangmanRound=1,LetterTimer=15,SelectedLetter=20}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=1,LetterTimer=65,SelectedLetter=20}] run playsound entity.arrow.hit_player master @a 1001 66 -11 1 0.75 0

scoreboard players set @e[scores={HangmanRound=1,LetterTimer=15,SelectedLetter=15}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=1,LetterTimer=75,SelectedLetter=15}] run setblock 1002 66 -11 black_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"O\"}",Patterns:[{Pattern: "ts", Color: 0}, {Pattern: "bs", Color: 0}, {Pattern: "ls", Color: 0}, {Pattern: "rs", Color: 0}, {Pattern: "rs", Color: 0}, {Pattern: "bo", Color: 15}]}
execute if entity @e[scores={HangmanRound=1,LetterTimer=75,SelectedLetter=15}] run playsound entity.arrow.hit_player master @a 1002 66 -11 1 0.8 0

scoreboard players set @e[scores={HangmanRound=1,LetterTimer=15,SelectedLetter=14}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=1,LetterTimer=65,SelectedLetter=14}] run playsound entity.arrow.hit_player master @a 1003 66 -11 1 0.85 0

scoreboard players set @e[scores={HangmanRound=1,LetterTimer=15,SelectedLetter=5}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=1,LetterTimer=65,SelectedLetter=5}] run playsound entity.arrow.hit_player master @a 1004 66 -11 1 0.9 0


# ROUND 2 -> ENDERMITE
scoreboard players set @e[scores={HangmanRound=2,LetterTimer=15,SelectedLetter=5}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=5}] run setblock 996 66 -11 purple_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"E\"}",Patterns:[{Pattern: "vh", Color: 0}, {Pattern: "cs", Color: 10}, {Pattern: "ms", Color: 0}, {Pattern: "rs", Color: 10}, {Pattern: "ts", Color: 0}, {Pattern: "bs", Color: 0}, {Pattern: "bo", Color: 10}]}
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=5}] run playsound entity.arrow.hit_player master @a 996 66 -11 1 0.5 0

scoreboard players set @e[scores={HangmanRound=2,LetterTimer=15,SelectedLetter=14}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=14}] run playsound entity.arrow.hit_player master @a 997 66 -11 1 0.55 0

scoreboard players set @e[scores={HangmanRound=2,LetterTimer=15,SelectedLetter=4}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=4}] run setblock 998 66 -11 purple_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"D\"}",Patterns:[{Pattern: "vh", Color: 0}, {Pattern: "rs", Color: 0}, {Pattern: "ts", Color: 0}, {Pattern: "bs", Color: 0}, {Pattern: "bo", Color: 10}]}
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=4}] run playsound entity.arrow.hit_player master @a 998 66 -11 1 0.6 0

scoreboard players set @e[scores={HangmanRound=2,LetterTimer=15,SelectedLetter=5}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=2,LetterTimer=75,SelectedLetter=5}] run setblock 999 66 -11 purple_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"E\"}",Patterns:[{Pattern: "vh", Color: 0}, {Pattern: "cs", Color: 10}, {Pattern: "ms", Color: 0}, {Pattern: "rs", Color: 10}, {Pattern: "ts", Color: 0}, {Pattern: "bs", Color: 0}, {Pattern: "bo", Color: 10}]}
execute if entity @e[scores={HangmanRound=2,LetterTimer=75,SelectedLetter=5}] run playsound entity.arrow.hit_player master @a 999 66 -11 1 0.65 0

scoreboard players set @e[scores={HangmanRound=2,LetterTimer=15,SelectedLetter=18}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=18}] run playsound entity.arrow.hit_player master @a 1000 66 -11 1 0.7 0

scoreboard players set @e[scores={HangmanRound=2,LetterTimer=15,SelectedLetter=13}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=13}] run setblock 1001 66 -11 purple_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"M\"}",Patterns:[{Pattern: "tt", Color: 0}, {Pattern: "tts", Color: 10}, {Pattern: "ls", Color: 0}, {Pattern: "rs", Color: 0}, {Pattern: "bo", Color: 10}]}
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=13}] run playsound entity.arrow.hit_player master @a 1001 66 -11 1 0.75 0

scoreboard players set @e[scores={HangmanRound=2,LetterTimer=15,SelectedLetter=9}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=9}] run setblock 1002 66 -11 purple_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"I\"}",Patterns:[{Pattern: "ts", Color: 0}, {Pattern: "bs", Color: 0}, {Pattern: "cs", Color: 0}, {Pattern: "bo", Color: 10}]}
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=9}] run playsound entity.arrow.hit_player master @a 1002 66 -11 1 0.8 0

scoreboard players set @e[scores={HangmanRound=2,LetterTimer=15,SelectedLetter=20}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=20}] run setblock 1003 66 -11 purple_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"T\"}",Patterns:[{Pattern: "ts", Color: 0}, {Pattern: "cs", Color: 0}, {Pattern: "bo", Color: 10}]}
execute if entity @e[scores={HangmanRound=2,LetterTimer=65,SelectedLetter=20}] run playsound entity.arrow.hit_player master @a 1003 66 -11 1 0.85 0

scoreboard players set @e[scores={HangmanRound=2,LetterTimer=15,SelectedLetter=5}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=2,LetterTimer=85,SelectedLetter=5}] run setblock 1004 66 -11 purple_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"E\"}",Patterns:[{Pattern: "vh", Color: 0}, {Pattern: "cs", Color: 10}, {Pattern: "ms", Color: 0}, {Pattern: "rs", Color: 10}, {Pattern: "ts", Color: 0}, {Pattern: "bs", Color: 0}, {Pattern: "bo", Color: 10}]}
execute if entity @e[scores={HangmanRound=2,LetterTimer=85,SelectedLetter=5}] run playsound entity.arrow.hit_player master @a 1004 66 -11 1 0.9 0


# ROUND 3 -> GUNPOWDER
scoreboard players set @e[scores={HangmanRound=3,LetterTimer=15,SelectedLetter=7}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=7}] run playsound entity.arrow.hit_player master @a 996 66 -11 1 0.5 0

scoreboard players set @e[scores={HangmanRound=3,LetterTimer=15,SelectedLetter=21}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=21}] run playsound entity.arrow.hit_player master @a 997 66 -11 1 0.55 0

scoreboard players set @e[scores={HangmanRound=3,LetterTimer=15,SelectedLetter=14}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=14}] run setblock 998 66 -11 white_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"N\"}",Patterns:[{Pattern: "drs", Color: 15}, {Pattern: "ls", Color: 15}, {Pattern: "rs", Color: 15}, {Pattern: "bo", Color: 0}]}
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=14}] run playsound entity.arrow.hit_player master @a 998 66 -11 1 0.6 0

scoreboard players set @e[scores={HangmanRound=3,LetterTimer=15,SelectedLetter=16}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=16}] run playsound entity.arrow.hit_player master @a 999 66 -11 1 0.65 0

scoreboard players set @e[scores={HangmanRound=3,LetterTimer=15,SelectedLetter=15}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=15}] run setblock 1000 66 -11 white_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"O\"}",Patterns:[{Pattern: "ts", Color: 15}, {Pattern: "bs", Color: 15}, {Pattern: "ls", Color: 15}, {Pattern: "rs", Color: 15}, {Pattern: "rs", Color: 15}, {Pattern: "bo", Color: 0}]}
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=15}] run playsound entity.arrow.hit_player master @a 1000 66 -11 1 0.7 0

scoreboard players set @e[scores={HangmanRound=3,LetterTimer=15,SelectedLetter=23}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=23}] run setblock 1001 66 -11 white_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"W\"}",Patterns:[{Pattern: "bt", Color: 15}, {Pattern: "bts", Color: 0}, {Pattern: "ls", Color: 15}, {Pattern: "rs", Color: 15}, {Pattern: "bo", Color: 0}]}
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=23}] run playsound entity.arrow.hit_player master @a 1001 66 -11 1 0.75 0

scoreboard players set @e[scores={HangmanRound=3,LetterTimer=15,SelectedLetter=4}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=4}] run setblock 1002 66 -11 white_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"D\"}",Patterns:[{Pattern: "vh", Color: 15}, {Pattern: "rs", Color: 15}, {Pattern: "ts", Color: 15}, {Pattern: "bs", Color: 15}, {Pattern: "bo", Color: 0}]}
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=4}] run playsound entity.arrow.hit_player master @a 1002 66 -11 1 0.8 0

scoreboard players set @e[scores={HangmanRound=3,LetterTimer=15,SelectedLetter=5}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=5}] run setblock 1003 66 -11 white_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"E\"}",Patterns:[{Pattern: "vh", Color: 15}, {Pattern: "cs", Color: 0}, {Pattern: "ms", Color: 15}, {Pattern: "rs", Color: 0}, {Pattern: "ts", Color: 15}, {Pattern: "bs", Color: 15}, {Pattern: "bo", Color: 0}]}
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=5}] run playsound entity.arrow.hit_player master @a 1003 66 -11 1 0.85 0

scoreboard players set @e[scores={HangmanRound=3,LetterTimer=15,SelectedLetter=18}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=18}] run setblock 1004 66 -11 white_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"R\"}",Patterns:[{Pattern: "rs", Color: 15}, {Pattern: "hhb", Color: 0}, {Pattern: "drs", Color: 15}, {Pattern: "ld", Color: 0}, {Pattern: "ld", Color: 0}, {Pattern: "ld", Color: 0}, {Pattern: "ts", Color: 15}, {Pattern: "vh", Color: 15}, {Pattern: "ms", Color: 15}, {Pattern: "bo", Color: 0}]}
execute if entity @e[scores={HangmanRound=3,LetterTimer=65,SelectedLetter=18}] run playsound entity.arrow.hit_player master @a 1004 66 -11 1 0.9 0


# ROUND 4 -> SWAMPLAND
scoreboard players set @e[scores={HangmanRound=4,LetterTimer=15,SelectedLetter=19}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=4,LetterTimer=65,SelectedLetter=19}] run playsound entity.arrow.hit_player master @a 996 66 -11 1 0.5 0

scoreboard players set @e[scores={HangmanRound=4,LetterTimer=15,SelectedLetter=23}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=4,LetterTimer=65,SelectedLetter=23}] run playsound entity.arrow.hit_player master @a 997 66 -11 1 0.55 0

scoreboard players set @e[scores={HangmanRound=4,LetterTimer=15,SelectedLetter=1}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=4,LetterTimer=65,SelectedLetter=1}] run playsound entity.arrow.hit_player master @a 998 66 -11 1 0.6 0

scoreboard players set @e[scores={HangmanRound=4,LetterTimer=15,SelectedLetter=13}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=4,LetterTimer=65,SelectedLetter=13}] run playsound entity.arrow.hit_player master @a 999 66 -11 1 0.65 0

scoreboard players set @e[scores={HangmanRound=4,LetterTimer=15,SelectedLetter=16}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=4,LetterTimer=65,SelectedLetter=16}] run playsound entity.arrow.hit_player master @a 1000 66 -11 1 0.7 0

scoreboard players set @e[scores={HangmanRound=4,LetterTimer=15,SelectedLetter=12}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=4,LetterTimer=65,SelectedLetter=12}] run playsound entity.arrow.hit_player master @a 1001 66 -11 1 0.75 0
...
execute if entity @e[scores={HangmanRound=4,LetterTimer=75,SelectedLetter=1}] run playsound entity.arrow.hit_player master @a 1002 66 -11 1 0.8 0

scoreboard players set @e[scores={HangmanRound=4,LetterTimer=15,SelectedLetter=14}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=4,LetterTimer=65,SelectedLetter=14}] run playsound entity.arrow.hit_player master @a 1003 66 -11 1 0.85 0

scoreboard players set @e[scores={HangmanRound=4,LetterTimer=15,SelectedLetter=4}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=4,LetterTimer=65,SelectedLetter=4}] run playsound entity.arrow.hit_player master @a 1004 66 -11 1 0.9 0


# ROUND 5 -> CHAINMAIL
scoreboard players set @e[scores={HangmanRound=5,LetterTimer=15,SelectedLetter=3}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=3}] run setblock 996 66 -11 orange_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"C\"}",Patterns:[{Pattern: "ts", Color: 0}, {Pattern: "bs", Color: 0}, {Pattern: "rs", Color: 0}, {Pattern: "ms", Color: 1}, {Pattern: "ls", Color: 0}, {Pattern: "bo", Color: 1}]}
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=3}] run playsound entity.arrow.hit_player master @a 996 66 -11 1 0.5 0

scoreboard players set @e[scores={HangmanRound=5,LetterTimer=15,SelectedLetter=8}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=8}] run playsound entity.arrow.hit_player master @a 997 66 -11 1 0.55 0

scoreboard players set @e[scores={HangmanRound=5,LetterTimer=15,SelectedLetter=1}] CorrectLetter 1
...
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=1}] run playsound entity.arrow.hit_player master @a 998 66 -11 1 0.6 0

scoreboard players set @e[scores={HangmanRound=5,LetterTimer=15,SelectedLetter=9}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=9}] run setblock 999 66 -11 orange_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"I\"}",Patterns:[{Pattern: "ts", Color: 0}, {Pattern: "bs", Color: 0}, {Pattern: "cs", Color: 0}, {Pattern: "bo", Color: 1}]}
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=9}] run playsound entity.arrow.hit_player master @a 999 66 -11 1 0.65 0

scoreboard players set @e[scores={HangmanRound=5,LetterTimer=15,SelectedLetter=14}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=14}] run setblock 1000 66 -11 orange_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"N\"}",Patterns:[{Pattern: "drs", Color: 0}, {Pattern: "ls", Color: 0}, {Pattern: "rs", Color: 0}, {Pattern: "bo", Color: 1}]}
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=14}] run playsound entity.arrow.hit_player master @a 1000 66 -11 1 0.7 0

scoreboard players set @e[scores={HangmanRound=5,LetterTimer=15,SelectedLetter=13}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=13}] run setblock 1001 66 -11 orange_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"M\"}",Patterns:[{Pattern: "tt", Color: 0}, {Pattern: "tts", Color: 1}, {Pattern: "ls", Color: 0}, {Pattern: "rs", Color: 0}, {Pattern: "bo", Color: 1}]}
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=13}] run playsound entity.arrow.hit_player master @a 1001 66 -11 1 0.75 0
...
execute if entity @e[scores={HangmanRound=5,LetterTimer=75,SelectedLetter=1}] run playsound entity.arrow.hit_player master @a 1002 66 -11 1 0.8 0

scoreboard players set @e[scores={HangmanRound=5,LetterTimer=15,SelectedLetter=9}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=5,LetterTimer=75,SelectedLetter=9}] run setblock 1003 66 -11 orange_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"I\"}",Patterns:[{Pattern: "ts", Color: 0}, {Pattern: "bs", Color: 0}, {Pattern: "cs", Color: 0}, {Pattern: "bo", Color: 1}]}
execute if entity @e[scores={HangmanRound=5,LetterTimer=75,SelectedLetter=9}] run playsound entity.arrow.hit_player master @a 1003 66 -11 1 0.85 0

scoreboard players set @e[scores={HangmanRound=5,LetterTimer=15,SelectedLetter=12}] CorrectLetter 1
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=12}] run setblock 1004 66 -11 orange_wall_banner[facing=south]{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"L\"}",Patterns:[{Pattern: "ls", Color: 0}, {Pattern: "bs", Color: 0}, {Pattern: "bo", Color: 1}]}
execute if entity @e[scores={HangmanRound=5,LetterTimer=65,SelectedLetter=12}] run playsound entity.arrow.hit_player master @a 1004 66 -11 1 0.9 0
...
execute if entity @e[scores={HangmanRound=2}] if block 996 66 -11 purple_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"E\"}"} if block 997 66 -11 purple_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"N\"}"} if block 998 66 -11 purple_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"D\"}"} if block 999 66 -11 purple_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"E\"}"} if block 1000 66 -11 purple_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"R\"}"} if block 1001 66 -11 purple_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"M\"}"} if block 1002 66 -11 purple_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"I\"}"} if block 1003 66 -11 purple_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"T\"}"} if block 1004 66 -11 purple_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"E\"}"} run scoreboard players set @e[scores={HangmanSetup=1..}] HangmanSetup -1000

execute if entity @e[scores={HangmanRound=3}] if block 996 66 -11 white_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"G\"}"} if block 997 66 -11 white_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"U\"}"} if block 998 66 -11 white_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"N\"}"} if block 999 66 -11 white_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"P\"}"} if block 1000 66 -11 white_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"O\"}"} if block 1001 66 -11 white_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"W\"}"} if block 1002 66 -11 white_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"D\"}"} if block 1003 66 -11 white_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"E\"}"} if block 1004 66 -11 white_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"R\"}"} run scoreboard players set @e[scores={HangmanSetup=1..}] HangmanSetup -1000
...
execute if entity @e[scores={HangmanRound=5}] if block 996 66 -11 orange_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"C\"}"} if block 997 66 -11 orange_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"H\"}"} if block 998 66 -11 orange_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"A\"}"} if block 999 66 -11 orange_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"I\"}"} if block 1000 66 -11 orange_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"N\"}"} if block 1001 66 -11 orange_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"M\"}"} if block 1002 66 -11 orange_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"A\"}"} if block 1003 66 -11 orange_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"I\"}"} if block 1004 66 -11 orange_wall_banner{CustomName:"{\"bold\":true,\"italic\":false,\"color\":\"white\",\"text\":\"L\"}"} run scoreboard players set @e[scores={HangmanSetup=1..}] HangmanSetup -1000

execute if entity @e[scores={HangmanSetup=-999}] run setblock 998 63 -6 birch_leaves[persistent=true]
#execute if entity @e[scores={HangmanSetup=-999}] run summon armor_stand 998.8 64 -5.2 {Tags:["BannerBlocker2"],Invisible:true,DisabledSlots:2039583}
#execute if entity @e[scores={HangmanSetup=-999}] run summon armor_stand 998.1 64 -5.2 {Tags:["BannerBlocker2"],Invisible:true,DisabledSlots:2039583}
#execute if entity @e[scores={HangmanSetup=-999}] run summon armor_stand 998.8 64 -5.9 {Tags:["BannerBlocker2"],Invisible:true,DisabledSlots:2039583}
#execute if entity @e[scores={HangmanSetup=-999}] run summon armor_stand 998.1 64 -5.9 {Tags:["BannerBlocker2"],Invisible:true,DisabledSlots:2039583}
