...
tag @s add YellowRing4

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -23 7 78 clay run setblock -23 7 78 yellow_terracotta


# SWAPS RING
execute if block -1527 186 2221 polished_andesite run function d3:elytra/yellow_course/calculate_yellow_rings
fill -1531 178 2221 -1523 186 2221 yellow_terracotta replace polished_andesite