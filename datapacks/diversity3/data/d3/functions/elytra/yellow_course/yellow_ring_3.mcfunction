...
tag @s add YellowRing3

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -23 6 78 clay run setblock -23 6 78 yellow_terracotta


# SWAPS RING
execute if block -1531 161 2225 polished_andesite run function d3:elytra/yellow_course/calculate_yellow_rings
fill -1531 153 2221 -1531 161 2229 yellow_terracotta replace polished_andesite