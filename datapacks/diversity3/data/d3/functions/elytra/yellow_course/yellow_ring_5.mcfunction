...
tag @s add YellowRing5

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -23 8 78 clay run setblock -23 8 78 yellow_terracotta


# SWAPS RING
execute if block -1585 115 2287 polished_andesite run function d3:elytra/yellow_course/calculate_yellow_rings
fill -1585 107 2283 -1585 115 2291 yellow_terracotta replace polished_andesite