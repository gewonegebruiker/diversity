...
tag @s add YellowRing7

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -23 10 78 clay run setblock -23 10 78 yellow_terracotta


# SWAPS RING
execute if block -1678 119 2244 polished_andesite run function d3:elytra/yellow_course/calculate_yellow_rings
fill -1682 111 2244 -1674 119 2244 yellow_terracotta replace polished_andesite