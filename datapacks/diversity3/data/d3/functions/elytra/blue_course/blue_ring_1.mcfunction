...
# SWAPS SPAWN BLOCK
execute if block -31 4 78 clay run setblock -31 4 78 light_blue_terracotta


# SWAPS RING
execute if block -1960 185 1930 polished_andesite run function d3:elytra/blue_course/calculate_blue_rings
fill -1960 177 1926 -1960 185 1934 light_blue_terracotta replace polished_andesite