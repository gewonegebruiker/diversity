...
tag @s add GreenRing2

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -28 5 78 clay run setblock -28 5 78 green_terracotta


# SWAPS RING
execute if block -1902 189 2017 polished_andesite run function d3:elytra/green_course/calculate_green_rings
fill -1902 181 2013 -1902 189 2021 green_terracotta replace polished_andesite