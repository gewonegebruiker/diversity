...
tag @s add GreenRing1

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -28 4 78 clay run setblock -28 4 78 green_terracotta


# SWAPS RING
execute if block -1887 202 1976 polished_andesite run function d3:elytra/green_course/calculate_green_rings
fill -1887 194 1972 -1887 202 1980 green_terracotta replace polished_andesite