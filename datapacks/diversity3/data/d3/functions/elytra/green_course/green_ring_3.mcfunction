...
tag @s add GreenRing3

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -28 6 78 clay run setblock -28 6 78 green_terracotta


# SWAPS RING
execute if block -1904 158 2033 polished_andesite run function d3:elytra/green_course/calculate_green_rings
fill -1908 158 2025 -1900 158 2033 green_terracotta replace polished_andesite