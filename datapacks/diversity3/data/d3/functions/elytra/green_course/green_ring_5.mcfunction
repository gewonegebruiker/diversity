...
tag @s add GreenRing5

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -28 8 78 clay run setblock -28 8 78 green_terracotta


# SWAPS RING
execute if block -2057 131 2031 polished_andesite run function d3:elytra/green_course/calculate_green_rings
fill -2061 123 2031 -2053 131 2031 green_terracotta replace polished_andesite