...
tag @s add BrownRing3

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -26 6 78 clay run setblock -26 6 78 brown_terracotta


# SWAPS RING
execute if block -1301 152 1986 polished_andesite run function d3:elytra/brown_course/calculate_brown_rings
fill -1301 144 1982 -1301 152 1990 brown_terracotta replace polished_andesite