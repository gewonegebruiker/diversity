...
tag @s add BrownRing4

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -26 7 78 clay run setblock -26 7 78 brown_terracotta


# SWAPS RING
execute if block -1211 145 2004 polished_andesite run function d3:elytra/brown_course/calculate_brown_rings
fill -1211 137 2000 -1211 145 2008 brown_terracotta replace polished_andesite