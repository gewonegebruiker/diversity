...
tag @s add BrownRing6

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -26 9 78 clay run setblock -26 9 78 brown_terracotta


# SWAPS RING
execute if block -931 68 1999 polished_andesite run function d3:elytra/brown_course/calculate_brown_rings
fill -931 60 1995 -931 68 2003 brown_terracotta replace polished_andesite