...
tag @s add BrownRing1

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -26 4 78 clay run setblock -26 4 78 brown_terracotta


# SWAPS RING
execute if block -1658 207 1999 polished_andesite run function d3:elytra/brown_course/calculate_brown_rings
fill -1658 199 1995 -1658 207 2003 brown_terracotta replace polished_andesite