...
tag @s add PurpleRing1

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -25 4 78 clay run setblock -25 4 78 purple_terracotta


# SWAPS RING
execute if block -1887 166 2181 polished_andesite run function d3:elytra/purple_course/calculate_purple_rings
fill -1891 158 2181 -1883 166 2181 purple_terracotta replace polished_andesite