...
tag @s add PurpleRing5

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -25 8 78 clay run setblock -25 8 78 purple_terracotta


# SWAPS RING
execute if block -2351 105 2206 polished_andesite run function d3:elytra/purple_course/calculate_purple_rings
fill -2355 97 2206 -2347 105 2206 purple_terracotta replace polished_andesite