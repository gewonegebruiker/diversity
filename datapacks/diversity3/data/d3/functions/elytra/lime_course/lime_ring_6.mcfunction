...
# SWAPS SPAWN BLOCK
execute if block -30 9 78 clay run setblock -30 9 78 lime_terracotta


# SWAPS RING
execute if block -1811 47 1692 polished_andesite run function d3:elytra/lime_course/calculate_lime_rings
fill -1811 39 1688 -1811 47 1696 lime_terracotta replace polished_andesite