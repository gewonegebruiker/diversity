...
tag @s add OrangeRing2

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -24 5 78 clay run setblock -24 5 78 orange_terracotta


# SWAPS RING
execute if block -1805 177 2215 polished_andesite run function d3:elytra/orange_course/calculate_orange_rings
fill -1805 169 2211 -1805 177 2219 orange_terracotta replace polished_andesite