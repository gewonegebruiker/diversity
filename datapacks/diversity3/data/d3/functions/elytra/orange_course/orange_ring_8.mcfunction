...
tag @s add OrangeRing8

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -24 11 78 clay run setblock -24 11 78 orange_terracotta


# SWAPS RING
execute if block -1830 195 2489 polished_andesite run function d3:elytra/orange_course/calculate_orange_rings
fill -1834 187 2489 -1826 195 2489 orange_terracotta replace polished_andesite