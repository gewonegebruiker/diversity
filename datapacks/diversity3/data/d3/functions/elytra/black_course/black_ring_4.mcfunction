...
tag @s add BlackRing4

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -29 7 78 clay run setblock -29 7 78 black_terracotta


# SWAPS RING
execute if block -1529 139 1749 polished_andesite run function d3:elytra/black_course/calculate_black_rings
fill -1529 131 1745 -1529 139 1753 black_terracotta replace polished_andesite