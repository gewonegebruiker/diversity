...
tag @s add BlackRing5

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -29 8 78 clay run setblock -29 8 78 black_terracotta


# SWAPS RING
execute if block -1651 92 1823 polished_andesite run function d3:elytra/black_course/calculate_black_rings
fill -1655 84 1823 -1647 92 1823 black_terracotta replace polished_andesite