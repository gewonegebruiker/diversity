...
tag @s add BlackRing8

scoreboard players set @s[scores={RingSFX=0}] RingSFX 1

# SWAPS SPAWN BLOCK
execute if block -29 11 78 clay run setblock -29 11 78 black_terracotta


# SWAPS RING
execute if block -1431 40 1575 polished_andesite run function d3:elytra/black_course/calculate_black_rings
fill -1435 32 1575 -1427 40 1575 black_terracotta replace polished_andesite