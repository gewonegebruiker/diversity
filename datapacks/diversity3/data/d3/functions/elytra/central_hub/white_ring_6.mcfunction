...
# SWAPS SPAWN BLOCK
execute if block -27 9 78 clay run setblock -27 9 78 white_terracotta


# SWAPS RING
execute if block -1787 189 2001 polished_andesite run function d3:elytra/central_hub/calculate_white_rings
fill -1791 181 2001 -1783 189 2001 white_terracotta replace polished_andesite