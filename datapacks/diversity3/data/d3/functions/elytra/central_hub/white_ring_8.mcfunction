...
# SWAPS SPAWN BLOCK
execute if block -27 11 78 clay run setblock -27 11 78 white_terracotta


# SWAPS RING
execute if block -1823 205 1990 polished_andesite run function d3:elytra/central_hub/calculate_white_rings
fill -1827 205 1982 -1819 205 1990 white_terracotta replace polished_andesite