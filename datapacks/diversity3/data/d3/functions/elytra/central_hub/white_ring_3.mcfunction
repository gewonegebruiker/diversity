...
# SWAPS SPAWN BLOCK
execute if block -27 6 78 clay run setblock -27 6 78 white_terracotta


# SWAPS RING
execute if block -1804 203 1977 polished_andesite run function d3:elytra/central_hub/calculate_white_rings
fill -1804 195 1973 -1804 203 1981 white_terracotta replace polished_andesite