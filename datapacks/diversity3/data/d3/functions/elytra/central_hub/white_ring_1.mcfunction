...
# SWAPS SPAWN BLOCK
execute if block -27 4 78 clay run setblock -27 4 78 white_terracotta


# SWAPS RING
execute if block -1800 217 2023 polished_andesite run function d3:elytra/central_hub/calculate_white_rings
fill -1800 209 2019 -1800 217 2027 white_terracotta replace polished_andesite