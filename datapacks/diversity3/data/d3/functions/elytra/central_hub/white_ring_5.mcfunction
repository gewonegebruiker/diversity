...
# SWAPS SPAWN BLOCK
execute if block -27 8 78 clay run setblock -27 8 78 white_terracotta


# SWAPS RING
execute if block -1804 194 2012 polished_andesite run function d3:elytra/central_hub/calculate_white_rings
fill -1804 186 2008 -1804 194 2016 white_terracotta replace polished_andesite