...
# SWAPS SPAWN BLOCK
execute if block -27 5 78 clay run setblock -27 5 78 white_terracotta


# SWAPS RING
execute if block -1775 209 1999 polished_andesite run function d3:elytra/central_hub/calculate_white_rings
fill -1779 201 1999 -1771 209 1999 white_terracotta replace polished_andesite